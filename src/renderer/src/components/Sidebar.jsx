  ...
  return (
    <aside className="w-64 min-h-screen bg-[#0f1117] border-r border-[#1e2130] flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-[#1e2130]">
        <p className="text-[#4a5568] text-xs font-semibold uppercase tracking-wider px-3 mb-2">Quick Links</p>
        <a
        ...
        <a
          href="https://dialer.swiftpathcapital.net"
          target="_blank"
          rel="noreferrer"
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-[#8892a4] hover:bg-[#161b27] hover:text-white transition-all duration-150"
        >
